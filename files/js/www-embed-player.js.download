...
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Io;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Pa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
;var Le={eo:"WEB_DISPLAY_MODE_UNKNOWN",Zn:"WEB_DISPLAY_MODE_BROWSER",bo:"WEB_DISPLAY_MODE_MINIMAL_UI",co:"WEB_DISPLAY_MODE_STANDALONE",ao:"WEB_DISPLAY_MODE_FULLSCREEN"};function Me(){this.data_=[];this.h=-1}
...
r(fh,H);var gh;gh=new function(a,b){this.h=a;this.fieldName=b;this.isRepeated=0;this.i=jd}(406606992,{Ao:0},fh);function hh(){fh.apply(this,arguments)}
...
function ek(a,b,c){c=void 0===c?{}:c;var d={};L("enable_web_eom_visitor_data")&&B("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":B("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||B("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.vo||B("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().uo:b=Yd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=B("SESSION_INDEX",0),L("pageid_as_header_web")&&(d["X-Goog-PageId"]=B("DELEGATED_SESSION_ID")));return d}
...
;var ko=y.ytLoggingDocDocumentNonce_;ko||(ko=Zn(),Wa("ytLoggingDocDocumentNonce_",ko));var lo=ko;var mo={sg:0,md:1,ud:2,Uj:3,ug:4,Sn:5,Kk:6,km:7,Ml:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function no(a){this.h=a}
...
jo:34388,ko:17657,lo:17655,mo:39579,no:39578,oo:77448,po:8196,qo:11357,ro:69877,so:8197,to:82039};function Bo(){var a=tb(Co),b;return Of(new Hf(function(c,d){a.onSuccess=function(e){xi(e)?c(new Do(e)):d(new Eo("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
;var To={identityType:"UNAUTHENTICATED_IDENTITY_TYPE_UNKNOWN"};var Uo=new Map([["dark","USER_INTERFACE_THEME_DARK"],["light","USER_INTERFACE_THEME_LIGHT"]]),Vo=["/fashion","/feed/fashion_destination","/channel/UCrpQ4p1Ql_hG8rKXIKM1MOQ"];function Wo(){var a=void 0===a?window.location.href:a;if(L("kevlar_disable_theme_param"))return null;var b=Yb(a.match(Xb)[5]||null);if(Xo(b))return"USER_INTERFACE_THEME_DARK";try{var c=qi(a).theme;return Uo.get(c)||null}catch(d){}return null}
function Xo(a){var b=Vo.map(function(c){return c.toLowerCase()});
return!L("disable_dark_fashion_destination_launch")&&b.some(function(c){return a.toLowerCase().startsWith(c)})?!0:!1}
;function Yo(){this.h={};if(this.i=Kj()){var a=Jj("CONSISTENCY");a&&Zo(this,{encryptedTokenJarContents:a})}}
Yo.prototype.handleResponse=function(a,b){var c,d,e;b=(null===(d=null===(c=b.aa.context)||void 0===c?void 0:c.request)||void 0===d?void 0:d.consistencyTokenJars)||[];(a=null===(e=a.responseContext)||void 0===e?void 0:e.consistencyTokenJar)&&this.replace(b,a)};
Yo.prototype.replace=function(a,b){a=q(a);for(var c=a.next();!c.done;c=a.next())delete this.h[c.value.encryptedTokenJarContents];Zo(this,b)};
function Zo(a,b){if(b.encryptedTokenJarContents&&(a.h[b.encryptedTokenJarContents]=b,"string"===typeof b.expirationSeconds)){var c=Number(b.expirationSeconds);setTimeout(function(){delete a.h[b.encryptedTokenJarContents]},1E3*c);
a.i&&Ij("CONSISTENCY",b.encryptedTokenJarContents,c,void 0,!0)}}
;var $o=window.location.hostname.split(".").slice(-2).join(".");function ap(){var a=B("LOCATION_PLAYABILITY_TOKEN");"TVHTML5"===B("INNERTUBE_CLIENT_NAME")&&(this.h=bp(this))&&(a=this.h.get("yt-location-playability-token"));a&&(this.locationPlayabilityToken=a,this.i=void 0)}
var cp;ap.getInstance=function(){cp=A("yt.clientLocationService.instance");cp||(cp=new ap,z("yt.clientLocationService.instance",cp,void 0));return cp};
ap.prototype.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.i?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=1E7*this.i.coords.latitude,a.client.locationInfo.longitudeE7=1E7*this.i.coords.longitude,a.client.locationInfo.horizontalAccuracyMeters=this.i.coords.accuracy,a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
ap.prototype.handleResponse=function(a){var b;a=null===(b=a.responseContext)||void 0===b?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.i=void 0,"TVHTML5"===B("INNERTUBE_CLIENT_NAME")?(this.h=bp(this))&&this.h.set("yt-location-playability-token",a,15552E3):Ij("YT_CL",JSON.stringify({loctok:a}),15552E3,$o,!0))};
function bp(a){return void 0===a.h?new gk("yt-client-location"):a.h}
ap.prototype.getCurrentPositionFromGeolocation=function(){var a=this;if(!(navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition)||!L("web_enable_browser_geolocation_api")&&!L("enable_handoff_location_2fa_on_mweb"))return Promise.reject(Error("Geolocation unsupported"));var b=!1,c=1E4;L("enable_handoff_location_2fa_on_mweb")&&(b=!0,c=15E3);return new Promise(function(d,e){navigator.geolocation.getCurrentPosition(function(f){a.i=f;d(f)},function(f){e(f)},{enableHighAccuracy:b,
maximumAge:0,timeout:c})})};
ap.prototype.createUnpluggedLocationInfo=function(a){var b={};a=a.coords;if(null===a||void 0===a?0:a.latitude)b.latitudeE7=Math.floor(1E7*a.latitude);if(null===a||void 0===a?0:a.longitude)b.longitudeE7=Math.floor(1E7*a.longitude);if(null===a||void 0===a?0:a.accuracy)b.locationRadiusMeters=Math.round(a.accuracy);return b};function dp(a,b){var c,d;if((null===(c=a.signalServiceEndpoint)||void 0===c?0:c.signal)&&b.Aa){var e=b.Aa[a.signalServiceEndpoint.signal];if(e)return e()}if((null===(d=a.continuationCommand)||void 0===d?0:d.request)&&b.Qb&&(e=b.Qb[a.continuationCommand.request]))return e();for(var f in a)if(b.pb[f]&&(a=b.pb[f]))return a()}
;var ep=Symbol("injectionDeps");function fp(){this.name="NETWORK_SLI_TOKEN"}
fp.prototype.toString=function(){return"InjectionToken("+this.name+")"};function gp(a){return function(){return new a}}
;var hp={},ip=(hp.WEB_UNPLUGGED="^unplugged/",hp.WEB_UNPLUGGED_ONBOARDING="^unplugged/",hp.WEB_UNPLUGGED_OPS="^unplugged/",hp.WEB_UNPLUGGED_PUBLIC="^unplugged/",hp.WEB_CREATOR="^creator/",hp.WEB_KIDS="^kids/",hp.WEB_EXPERIMENTS="^experiments/",hp.WEB_MUSIC="^music/",hp.WEB_REMIX="^music/",hp.WEB_MUSIC_EMBEDDED_PLAYER="^music/",hp.WEB_MUSIC_EMBEDDED_PLAYER="^main_app/|^sfv/",hp);
function jp(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=ip[b];if(c){var d=new RegExp(c),e=q(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(ip).forEach(function(g){var h=q(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
d=new RegExp(f.join("|"));a.sort(function(g,h){return g.length-h.length});
e=q(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,!d.exec(c))return c;return a[0]}
;function kp(a,b){return{method:void 0===b?"POST":b,mode:si(a)?"same-origin":"cors",credentials:si(a)?"same-origin":"include"}}
;function lp(){}
lp.prototype.o=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?To:c;var d;var e=a.clickTrackingParams,f=this.l,g=!1;g=void 0===g?!1:g;f=void 0===f?!1:f;var h=B("INNERTUBE_CONTEXT");if(h){h=ub(h);L("web_no_tracking_params_in_shell_killswitch")||delete h.clickTracking;var k,m;h.client||(h.client={});var n=h.client;"MWEB"===n.clientName&&(n.clientFormFactor=B("IS_TABLET")?"LARGE_FORM_FACTOR":"SMALL_FORM_FACTOR");n.screenWidthPoints=window.innerWidth;n.screenHeightPoints=window.innerHeight;n.screenPixelDensity=
Math.round(window.devicePixelRatio||1);n.screenDensityFloat=window.devicePixelRatio||1;n.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var t=void 0===t?!1:t;Mj.getInstance();var x="USER_INTERFACE_THEME_LIGHT";Pj(165)?x="USER_INTERFACE_THEME_DARK":Pj(174)?x="USER_INTERFACE_THEME_LIGHT":!L("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(x="USER_INTERFACE_THEME_DARK");t=t?x:Wo()||
...
(n.tvAppInfo=Object.assign(n.tvAppInfo||{},{certificationScope:m}));if(!L("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var u=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(Ga){}u=void 0}u&&(n.timeZone=u)}(u=xh())?n.experimentsToken=u:delete n.experimentsToken;u=yh();Yo.h||(Yo.h=new Yo);n=Yo.h.h;m=[];k=0;for(var C in n)m[k++]=n[C];h.request=Object.assign(Object.assign({},h.request),{internalExperimentFlags:u,consistencyTokenJars:m});!L("web_prequest_context_killswitch")&&
(C=B("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&(h.request.externalPrequestContext=C);u=Mj.getInstance();C=Pj(58);u=u.get("gsml","");h.user=Object.assign({},h.user);C&&(h.user.enableSafetyMode=C);u&&(h.user.lockedSafetyMode=!0);L("warm_op_csn_cleanup")?f&&(g=uo())&&(h.clientScreenNonce=g):!g&&(g=uo())&&(h.clientScreenNonce=g);e&&(h.clickTracking={clickTrackingParams:e});if(e=A("yt.mdx.remote.remoteClient_"))h.remoteClient=e;L("web_enable_client_location_service")&&ap.getInstance().setLocationOnInnerTubeContext(h);
try{var D=ti(void 0),K=D.bid;delete D.bid;h.adSignalsInfo={params:[],bid:K};for(var O=q(Object.entries(D)),Q=O.next();!Q.done;Q=O.next()){var U=q(Q.value),Z=U.next().value,Cd=U.next().value;D=Z;K=Cd;null===(d=h.adSignalsInfo.params)||void 0===d?void 0:d.push({key:D,value:""+K})}}catch(Ga){Sn(Ga)}d=h}else Sn(Error("Error: No InnerTubeContext shell provided in ytconfig.")),d={};d={context:d};if(O=this.h(a)){this.i(d,O,b);var da,ia;b="/youtubei/v1/"+jp(this.j());(a=null===(ia=null===(da=a.commandMetadata)||
void 0===da?void 0:da.webCommandMetadata)||void 0===ia?void 0:ia.apiUrl)&&(b=a);da=b;(ia=B("INNERTUBE_HOST_OVERRIDE"))&&(da=String(ia)+String($b(da)));ia={};ia.key=B("INNERTUBE_API_KEY");L("json_condensed_response")&&(ia.prettyPrint="false");da=ri(da,ia||{},!1);da={input:da,sa:kp(da),aa:d,config:Object.assign({},void 0)};da.config.Ha?da.config.Ha.identity=c:da.config.Ha={identity:c};return da}Sn(new M("Error: Failed to create Request from Command.",a))};
ea.Object.defineProperties(lp.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!1}}});function mp(){}
r(mp,lp);mp.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",sa:kp("/getDatasyncIdsEndpoint","GET"),aa:{}}};
mp.prototype.j=function(){return[]};
mp.prototype.h=function(){};
mp.prototype.i=function(){};var np={},op=(np.GET_DATASYNC_IDS=gp(mp),np);function pp(a){var b=Ea.apply(1,arguments);if(!qp(a)||b.some(function(e){return!qp(e)}))throw Error("Only objects may be merged.");
var c=a;b=q(b);for(var d=b.next();!d.done;d=b.next())rp(c,d.value);return c}
function rp(a,b){for(var c in b)if(qp(b[c])){if(c in a&&!qp(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});rp(a[c],b[c])}else if(sp(b[c])){if(c in a&&!sp(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);tp(a[c],b[c])}else a[c]=b[c];return a}
function tp(a,b){b=q(b);for(var c=b.next();!c.done;c=b.next())c=c.value,qp(c)?a.push(rp({},c)):sp(c)?a.push(tp([],c)):a.push(c);return a}
function qp(a){return"object"===typeof a&&!Array.isArray(a)}
function sp(a){return"object"===typeof a&&Array.isArray(a)}
;function up(a,b){bm.call(this,1,arguments);this.timer=b}
r(up,bm);var vp=new cm("aft-recorded",up);var wp=window;function xp(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var R=wp.performance||wp.mozPerformance||wp.msPerformance||wp.webkitPerformance||new xp;var yp=!1,zp={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"};
Ua(R.clearResourceTimings||R.webkitClearResourceTimings||R.mozClearResourceTimings||R.msClearResourceTimings||R.oClearResourceTimings||Ka,R);function Ap(a){var b=Bp(a);if(b.aft)return b.aft;a=B((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Cp(){var a;if(L("csi_use_performance_navigation_timing")){var b,c,d,e=null===(d=null===(c=null===(b=null===(a=null===R||void 0===R?void 0:R.getEntriesByType)||void 0===a?void 0:a.call(R,"navigation"))||void 0===b?void 0:b[0])||void 0===c?void 0:c.toJSON)||void 0===d?void 0:d.call(c);e?(e.requestStart=Dp(e.requestStart),e.responseEnd=Dp(e.responseEnd),e.redirectStart=Dp(e.redirectStart),e.redirectEnd=Dp(e.redirectEnd),e.domainLookupEnd=Dp(e.domainLookupEnd),e.connectStart=Dp(e.connectStart),
e.connectEnd=Dp(e.connectEnd),e.responseStart=Dp(e.responseStart),e.secureConnectionStart=Dp(e.secureConnectionStart),e.domainLookupStart=Dp(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=R.timing}else a=R.timing;return a}
function Ep(){return L("csi_use_time_origin")&&R.timeOrigin?Math.floor(R.timeOrigin):R.timing.navigationStart}
function Dp(a){return Math.round(Ep()+a)}
function Fp(a){var b;(b=A("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Wa("ytcsi."+(a||"")+"data_",b));return b}
function Gp(a){a=Fp(a);a.info||(a.info={});return a.info}
function Bp(a){a=Fp(a);a.tick||(a.tick={});return a.tick}
function Hp(a){a=Fp(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
function Ip(a){a=Hp(a);a.gelInfos||(a.gelInfos={});return a.gelInfos}
function Jp(a){var b=Fp(a).nonce;b||(b=Zn(),Fp(a).nonce=b);return b}
function Kp(a){var b=Bp(a||""),c=Ap(a);c&&!yp&&(hm(vp,new up(Math.round(c-b._start),a)),yp=!0)}
function Lp(a,b){for(var c=q(Object.keys(b)),d=c.next();!d.done;d=c.next())if(d=d.value,!Object.keys(a).includes(d)||"object"===typeof b[d]&&!Lp(a[d],b[d]))return!1;return!0}
;function Mp(){if(R.getEntriesByType){var a=R.getEntriesByType("paint");if(a=ib(a,function(b){return"first-paint"===b.name}))return Dp(a.startTime)}a=R.timing;
return a.cc?Math.max(0,a.cc):0}
;function Np(){var a=A("ytcsi.debug");a||(a=[],z("ytcsi.debug",a,void 0),z("ytcsi.reference",{},void 0));return a}
function Op(a){a=a||"";var b=A("ytcsi.reference");b||(Np(),b=A("ytcsi.reference"));if(b[a])return b[a];var c=Np(),d={timerName:a,info:{},tick:{},span:{},jspbInfo:[]};c.push(d);return b[a]=d}
;var S={},Pp=(S.auto_search="LATENCY_ACTION_AUTO_SEARCH",S.ad_to_ad="LATENCY_ACTION_AD_TO_AD",S.ad_to_video="LATENCY_ACTION_AD_TO_VIDEO",S["analytics.explore"]="LATENCY_ACTION_CREATOR_ANALYTICS_EXPLORE",S.app_startup="LATENCY_ACTION_APP_STARTUP",S["artist.analytics"]="LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS",S["artist.events"]="LATENCY_ACTION_CREATOR_ARTIST_CONCERTS",S["artist.presskit"]="LATENCY_ACTION_CREATOR_ARTIST_PROFILE",S.browse="LATENCY_ACTION_BROWSE",S.cast_splash="LATENCY_ACTION_CAST_SPLASH",
...
T.yt_vis="isVisible",T.rcl="mwebInfo.responseContentLength",T.GetSettings_rid="requestIds",T.GetTrending_rid="requestIds",T.GetMusicSearchSuggestions_rid="requestIds",T.REQUEST_ID="requestIds",T),Rp="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
Sp={},Tp=(Sp.ccs="CANARY_STATE_",Sp.mver="MEASUREMENT_VERSION_",Sp.pis="PLAYER_INITIALIZED_STATE_",Sp.yt_pt="LATENCY_PLAYER_",Sp.pa="LATENCY_ACTION_",Sp.ctop="TOP_ENTITY_TYPE_",Sp.yt_vst="VIDEO_STREAM_TYPE_",Sp),Up="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function Vp(a,b,c){c=Hp(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in Qp){c=Qp[a];0<=db(Rp,c)&&(b=!!b);a in Tp&&"string"===typeof b&&(b=Tp[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return pp({},d)}0<=db(Up,a)||Tn(new M("Unknown label logged with GEL CSI",a))}
...
Zp[Zp.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT]="LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";Zp[Zp.LATENCY_ACTION_ERROR_UNSPECIFIED]="LATENCY_ACTION_ERROR_UNSPECIFIED";var $p={LIVE_STREAM_MODE_WINDOW:5,LIVE_STREAM_MODE_POST:4,LIVE_STREAM_MODE_LP:3,LIVE_STREAM_MODE_LIVE:2,LIVE_STREAM_MODE_DVR:1,LIVE_STREAM_MODE_UNKNOWN:0};$p[$p.LIVE_STREAM_MODE_WINDOW]="LIVE_STREAM_MODE_WINDOW";$p[$p.LIVE_STREAM_MODE_POST]="LIVE_STREAM_MODE_POST";$p[$p.LIVE_STREAM_MODE_LP]="LIVE_STREAM_MODE_LP";
$p[$p.LIVE_STREAM_MODE_LIVE]="LIVE_STREAM_MODE_LIVE";$p[$p.LIVE_STREAM_MODE_DVR]="LIVE_STREAM_MODE_DVR";$p[$p.LIVE_STREAM_MODE_UNKNOWN]="LIVE_STREAM_MODE_UNKNOWN";var aq={VIDEO_STREAM_TYPE_VOD:3,VIDEO_STREAM_TYPE_DVR:2,VIDEO_STREAM_TYPE_LIVE:1,VIDEO_STREAM_TYPE_UNSPECIFIED:0};aq[aq.VIDEO_STREAM_TYPE_VOD]="VIDEO_STREAM_TYPE_VOD";aq[aq.VIDEO_STREAM_TYPE_DVR]="VIDEO_STREAM_TYPE_DVR";aq[aq.VIDEO_STREAM_TYPE_LIVE]="VIDEO_STREAM_TYPE_LIVE";aq[aq.VIDEO_STREAM_TYPE_UNSPECIFIED]="VIDEO_STREAM_TYPE_UNSPECIFIED";
var bq={YT_IDB_TRANSACTION_TYPE_READ:2,YT_IDB_TRANSACTION_TYPE_WRITE:1,YT_IDB_TRANSACTION_TYPE_UNKNOWN:0};bq[bq.YT_IDB_TRANSACTION_TYPE_READ]="YT_IDB_TRANSACTION_TYPE_READ";bq[bq.YT_IDB_TRANSACTION_TYPE_WRITE]="YT_IDB_TRANSACTION_TYPE_WRITE";bq[bq.YT_IDB_TRANSACTION_TYPE_UNKNOWN]="YT_IDB_TRANSACTION_TYPE_UNKNOWN";var cq={PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN:2,PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT:1,PLAYER_ROTATION_TYPE_UNKNOWN:0};cq[cq.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN]="PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
cq[cq.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";cq[cq.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var dq=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",dq,void 0);function eq(){this.h=0}
function fq(){eq.h||(eq.h=new eq);return eq.h}
eq.prototype.tick=function(a,b,c,d){gq(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},L("web_csi_via_jspb")?(d=new Wg,F(d,1,a),F(d,2,b),a=new Zg,Uc(a,5,d),bo(a,c)):wk("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
eq.prototype.info=function(a,b,c){var d=Object.keys(a).join("");gq(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,wk("latencyActionInfo",a,{cttAuthInfo:c}))};
eq.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));gq(this,"info_"+d+"_"+b)||(F(a,2,b),b={cttAuthInfo:c},c=new Zg,Uc(c,7,a),bo(c,b))};
eq.prototype.span=function(a,b,c){var d=Object.keys(a).join("");gq(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,wk("latencyActionSpan",a,{cttAuthInfo:c}))};
function gq(a,b){dq[b]=dq[b]||{count:0};var c=dq[b];c.count++;c.time=N();a.h||(a.h=Vh(function(){var d=N(),e;for(e in dq)dq[e]&&6E4<d-dq[e].time&&delete dq[e];a&&(a.h=0)},5E3));
...
71,Zp[a[e]]);break;case "actionStep":F(c,79,a[e]);break;case "jsHeapSizeLimit":F(c,80,a[e]);break;case "totalJsHeapSize":F(c,81,a[e]);break;case "usedJsHeapSize":F(c,82,a[e]);break;case "resourceInfo":Wc(c,83,Rg,a[e]);break;case "sourceVideoDurationMs":F(c,90,a[e]);break;case "playerInfo":G(c,22,a[e]);break;case "commentInfo":G(c,23,a[e]);break;case "mdxInfo":G(c,24,a[e]);break;case "watchInfo":G(c,35,a[e]);break;case "adPrebufferedTimeSecs":F(c,39,a[e]);break;case "thumbnailLoadInfo":G(c,40,a[e]);
break;case "creatorInfo":G(c,46,a[e]);break;case "unpluggedInfo":G(c,50,a[e]);break;case "isLivestream":F(c,47,a[e]);break;case "liveStreamMode":F(c,91,$p[a[e]]);break;case "adCpn2":F(c,48,a[e]);break;case "adDaiDriftMillis":F(c,49,a[e]);break;case "videoStreamType":F(c,53,aq[a[e]]);break;case "reelInfo":G(c,54,a[e]);break;case "subscriptionsFeedInfo":G(c,72,a[e]);break;case "playbackRequiresTap":F(c,56,a[e]);break;case "requestIds":Ug(c,a[e]);break;case "mediaBrowserActionInfo":G(c,58,a[e]);break;
case "performanceNavigationTiming":F(c,67,a[e]);break;case "musicLoadActionInfo":G(c,69,a[e]);break;case "transactionType":F(c,74,bq[a[e]]);break;case "shoppingInfo":G(c,75,a[e]);break;case "prefetchInfo":G(c,86,a[e]);break;case "accelerationSession":G(c,87,a[e]);break;case "playerRotationType":F(c,101,cq[a[e]]);break;case "webInfo":G(c,38,a[e]);break;case "tvInfo":G(c,51,a[e]);break;case "kabukiInfo":G(c,52,a[e]);break;case "mwebInfo":G(c,59,a[e]);break;case "musicInfo":G(c,65,a[e]);break;case "allowedPreroll":F(c,
10,a[e]);break;case "shownPreroll":F(c,11,a[e]);break;case "getHomeRequestId":F(c,57,a[e]);break;case "getSearchRequestId":F(c,60,a[e]);break;case "getPlayerRequestId":F(c,61,a[e]);break;case "getWatchNextRequestId":F(c,62,a[e]);break;case "getBrowseRequestId":F(c,63,a[e]);break;case "getLibraryRequestId":F(c,66,a[e])}}catch(g){Gh(Error("Codegen laipb translator failed to set "+f))}}iq(c,b)}else c=Op(b||""),pp(c.info,a),pp(Ip(b),a),c=Jp(b),b=Fp(b).cttAuthInfo,fq().info(a,c,b)}
function iq(a,b){var c=Hp(b);c.jspbInfos||(c.jspbInfos=[]);c.jspbInfos.push(a);Op(b||"").jspbInfo.push(a);c=Jp(b);b=Fp(b).cttAuthInfo;fq().jspbInfo(a,c,b)}
function Y(a,b,c){if(!b&&"_"!==a[0]){var d=a;R.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),R.mark(d))}Op(c||"").tick[a]=b||N();d=Hp(c);d.gelTicks&&(d.gelTicks[a]=!0);d=Bp(c);var e=b||N();d[a]=e;e=Jp(c);var f=Fp(c).cttAuthInfo;if("_start"===a){var g=fq();gq(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},L("web_csi_via_jspb")?(f=new Qg,F(f,1,e),e=new Zg,Uc(e,6,f),bo(e,b)):wk("latencyActionBaselined",{clientActionNonce:e},b))}else fq().tick(a,e,b,f);Kp(c);return d[a]}
function oq(){var a=Jp(void 0);requestAnimationFrame(function(){setTimeout(function(){a===Jp(void 0)&&Y("ol",void 0,void 0)},0)})}
function kq(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=Ch+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function nq(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);Ub()&&a.setAttribute("nonce",Ub());return c?(a=R.getEntriesByName(c))&&a[0]&&(a=a[0],c=Ep(),Y("rsf_"+b,c+Math.round(a.fetchStart)),Y("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function mq(){var a=window.location.protocol,b=R.getEntriesByType("resource");b=fb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=hb(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Y("wffs",Dp(b.startTime)),Y("wffe",Dp(b.responseEnd)))}
var pq=window;pq.ytcsi&&(pq.ytcsi.info=jq,pq.ytcsi.tick=Y);var qq=["consistency","mss","client_location","entities","store"];function rq(a,b,c,d){this.o=a;this.J=b;this.l=c;this.j=d;this.i=void 0;this.h=new Map;a.Aa||(a.Aa={});a.Aa=Object.assign(Object.assign({},op),a.Aa)}
function sq(a,b,c,d){if(void 0!==rq.h){if(d=rq.h,a=[a!==d.o,b!==d.J,c!==d.l,!1,!1,void 0!==d.i],a.some(function(e){return e}))throw new M("InnerTubeTransportService is already initialized",a);
}else rq.h=new rq(a,b,c,d)}
function tq(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?To:c;var d=dp(b,a.o);if(!d)return Mf(new M("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new Hf(function(f){var g,h,k;return w(function(m){if(1==m.h){h="cors"===(null===(g=e.sa)||void 0===g?void 0:g.mode)?"cors":void 0;if(a.l.xc){var n=e.config,t;n=null===(t=null===n||void 0===n?void 0:n.Ha)||void 0===t?void 0:t.sessionIndex;t=So({sessionIndex:n});k=Object.assign(Object.assign({},
uq(h)),t);return m.s(2)}return v(m,vq(e.config,h),3)}2!=m.h&&(k=m.i);f(wq(a,e,k));m.h=0})}):Mf(new M("Error: Failed to build request for command.",b))}
function wq(a,b,c){var d,e,f,g,h,k,m,n,t,x,u,C,D,K,O,Q,U;return w(function(Z){switch(Z.h){case 1:Z.s(2);break;case 3:if((m=Z.i)&&!m.isExpired())return Z.return(Promise.resolve(m.h()));case 2:if((n=null===(d=b.config)||void 0===d?void 0:d.Go)&&a.h.has(n)&&L("web_memoize_inflight_requests"))return Z.return(a.h.get(n));if(null===(e=null===b||void 0===b?void 0:b.aa)||void 0===e?0:e.context)for(t=q([]),x=t.next();!x.done;x=t.next())u=x.value,u.Eo(b.aa.context);if(null===(f=a.i)||void 0===f?0:f.l(b.input,
...
a.i.i(b.input,b.aa),6);case 6:O=Z.i;case 5:if(O&&a.j)for(Q=q(qq),x=Q.next();!x.done;x=Q.next())U=x.value,a.j[U]&&a.j[U].handleResponse(O,b);return Z.return(O)}})}
function vq(a,b){var c,d,e;return w(function(f){if(1==f.h){d=null===(c=null===a||void 0===a?void 0:a.Ha)||void 0===c?void 0:c.sessionIndex;var g=So({sessionIndex:d});if(!(g instanceof Hf)){var h=new Hf(Ka);If(h,2,g);g=h}return v(f,g,2)}e=f.i;return f.return(Promise.resolve(Object.assign(Object.assign({},uq(b)),e)))})}
function uq(a){var b={"Content-Type":"application/json"};L("enable_web_eom_visitor_data")&&B("EOM_VISITOR_DATA")?b["X-Goog-EOM-Visitor-Id"]=B("EOM_VISITOR_DATA"):B("VISITOR_DATA")&&(b["X-Goog-Visitor-Id"]=B("VISITOR_DATA"));"cors"!==a&&((a=B("INNERTUBE_CONTEXT_CLIENT_NAME"))&&(b["X-Youtube-Client-Name"]=a),(a=B("INNERTUBE_CONTEXT_CLIENT_VERSION"))&&(b["X-Youtube-Client-Version"]=a),(a=B("CHROME_CONNECTED_HEADER"))&&(b["X-Youtube-Chrome-Connected"]=a),L("forward_domain_admin_state_on_embeds")&&(a=
B("DOMAIN_ADMIN_STATE"))&&(b["X-Youtube-Domain-Admin-State"]=a));return b}
;var xq=["share/get_web_player_share_panel"],yq=["feedback"],zq=["notification/modify_channel_preference"],Aq=["browse/edit_playlist"],Bq=["subscription/subscribe"],Cq=["subscription/unsubscribe"];function Dq(){}
r(Dq,lp);Dq.prototype.j=function(){return Bq};
Dq.prototype.h=function(a){return a.subscribeEndpoint};
Dq.prototype.i=function(a,b,c){c=void 0===c?{}:c;b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params);c.botguardResponse&&(a.botguardResponse=c.botguardResponse);c.feature&&(a.clientFeature=c.feature)};
ea.Object.defineProperties(Dq.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Eq(){}
r(Eq,lp);Eq.prototype.j=function(){return Cq};
Eq.prototype.h=function(a){return a.unsubscribeEndpoint};
Eq.prototype.i=function(a,b){b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params)};
ea.Object.defineProperties(Eq.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Fq(){}
r(Fq,lp);Fq.prototype.j=function(){return yq};
Fq.prototype.h=function(a){return a.feedbackEndpoint};
Fq.prototype.i=function(a,b,c){a.feedbackTokens=[];b.feedbackToken&&a.feedbackTokens.push(b.feedbackToken);if(b=b.cpn||c.cpn)a.feedbackContext={cpn:b};a.isFeedbackTokenUnencrypted=!!c.is_feedback_token_unencrypted;a.shouldMerge=!1;c.extra_feedback_tokens&&(a.shouldMerge=!0,a.feedbackTokens=a.feedbackTokens.concat(c.extra_feedback_tokens))};
ea.Object.defineProperties(Fq.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Gq(){}
r(Gq,lp);Gq.prototype.j=function(){return zq};
Gq.prototype.h=function(a){return a.modifyChannelNotificationPreferenceEndpoint};
Gq.prototype.i=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function Hq(){}
r(Hq,lp);Hq.prototype.j=function(){return Aq};
Hq.prototype.h=function(a){return a.playlistEditEndpoint};
Hq.prototype.i=function(a,b){b.actions&&(a.actions=b.actions);b.params&&(a.params=b.params);b.playlistId&&(a.playlistId=b.playlistId)};function Iq(){}
r(Iq,lp);Iq.prototype.j=function(){return xq};
Iq.prototype.h=function(a){return a.webPlayerShareEntityServiceEndpoint};
Iq.prototype.i=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var Jq=new fp;function Kq(){}
Kq.prototype.fetch=function(a,b){var c=this,d,e,f;return w(function(g){if(1==g.h){d=new window.Request(a,b);if(L("web_fetch_promise_cleanup_killswitch"))return g.return(Promise.resolve(fetch(d).then(function(h){return c.handleResponse(h)}).catch(function(h){Tn(h)})));
...
return b};
Kq[ep]=[new function(a){this.key=a}(Jq)];var Lq;function Mq(a){bm.call(this,1,arguments);this.csn=a}
r(Mq,bm);var km=new cm("screen-created",Mq),Nq=[],Pq=Oq,Qq=0;function Rq(a,b,c,d,e,f,g){function h(){Tn(new M("newScreen() parent element does not have a VE - rootVe",b))}
var k=Pq();f=new no({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,W:k};if(L("il_via_jspb")){var m=new Gg;m.X(k);Hg(m,f.getAsJspb());c&&c.visualElement?(f=new Ig,c.clientScreenNonce&&F(f,2,c.clientScreenNonce),Jg(f,c.visualElement.getAsJspb()),g&&F(f,4,Fg[g]),G(m,5,f)):c&&h();d&&F(m,3,d);ho(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=g)):
c&&h(),d&&(f.cloneCsn=d),a?Dj("screenCreated",f,a,e):wk("screenCreated",f,e);hm(km,new Mq(k));return k}
function Sq(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:wo(b),
...
"UNDEFINED_CSN"==b?Tq("visualElementAttached",h,f):io(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:gb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?Tq("visualElementAttached",c,f):a?Dj("visualElementAttached",c,a,f):wk("visualElementAttached",c,f)}
function Oq(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Ac(b,3)}
function Tq(a,b,c){Nq.push({payloadName:a,payload:b,options:c});Qq||(Qq=lm())}
function mm(a){if(Nq){for(var b=q(Nq),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(L("il_via_jspb"))switch(c.payload.X(a.csn),c.payloadName){case "screenCreated":ho(c.payload,c.options);break;case "visualElementAttached":io(c.payload,c.options);break;case "visualElementShown":co(c.payload,c.options);break;case "visualElementHidden":eo(c.payload,c.options);break;case "visualElementGestured":fo(c.payload,c.options);break;case "visualElementStateChanged":go(c.payload,c.options);break;default:Tn(new M("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,Dj(c.payloadName,c.payload,null,c.options);Nq.length=0}Qq=0}
...
La(Uq);function Vq(){this.o=[];this.C=[];this.h=[];this.l=[];this.m=[];this.i=new Set;this.u=new Map}
function Wq(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=uo(c),h=so(c);g&&h&&((null===(e=null===d||void 0===d?void 0:d.response)||void 0===e?0:e.trackingParams)&&Sq(a.client,g,h,[oo(d.response.trackingParams)]),(null===(f=null===d||void 0===d?void 0:d.playerResponse)||void 0===f?0:f.trackingParams)&&Sq(a.client,g,h,[oo(d.playerResponse.trackingParams)]))})}
function Xq(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.o.push([b,c]);else{var e=uo(d);c=c||so(d);e&&c&&Sq(a.client,e,c,[b])}}
Vq.prototype.clickCommand=function(a,b,c){a:{var d=a.clickTrackingParams;c=void 0===c?0:c;c=void 0===c?0:c;if(d){if(L("web_ignore_no_ve_clicks")&&(a=Hn(atob(d.replace(/-/g,"+").replace(/_/g,"/"))),!a||0===a)){b=!1;break a}if(c=uo(c)){a=this.client;var e=oo(d);var f="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";d={cttAuthInfo:wo(c),W:c};if(L("il_via_jspb")){var g=new Ng;g.X(c);e=e.getAsJspb();G(g,2,e);F(g,4,Fg[f]);b&&G(g,3,void 0);"UNDEFINED_CSN"==c?Tq("visualElementGestured",g,d):fo(g,d,a)}else f=
{csn:c,ve:e.getAsJson(),gestureType:f},b&&(f.clientData=b),"UNDEFINED_CSN"==c?Tq("visualElementGestured",f,d):a?Dj("visualElementGestured",f,a,d):wk("visualElementGestured",f,d);b=!0}else b=!1}else b=!1}return b};
function Yq(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){Zq(a,b,c);var f=so(c.layer);if(f){for(var g=q(a.o),h=g.next();!h.done;h=g.next())h=h.value,Xq(a,h[0],h[1]||f,c.layer);f=q(a.C);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=uo(g);var m=k[0]||so(g);if(h&&m){g=a.client;var n=k[1];k={cttAuthInfo:wo(h),W:h};L("il_via_jspb")?(n=new Pg,n.X(h),m=m.getAsJspb(),G(n,2,m),"UNDEFINED_CSN"==h?Tq("visualElementStateChanged",n,k):go(n,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:n},"UNDEFINED_CSN"==h?Tq("visualElementStateChanged",m,k):g?Dj("visualElementStateChanged",m,g,k):wk("visualElementStateChanged",m,k))}}}};
uo(c.layer)||a.j();if(c.sb)for(var d=q(c.sb),e=d.next();!e.done;e=d.next())Wq(a,e.value,c.layer);else Sn(Error("Delayed screen needs a data promise."))}
function Zq(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.dc?c.dc:c.layer;var e=uo(d);d=so(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=B("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Rq(a.client,b,f,c.rb,c.cttAuthInfo,g,c.Bo)}catch(m){Un(m,{Ho:b,rootVe:d,parentVisualElement:void 0,yo:e,Do:f,rb:c.rb});Sn(m);return}xo(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=q(Object.values(mo));for(f=b.next();!f.done;f=b.next())if(uo(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:wo(e),W:e,ub:g},L("il_via_jspb")?(h=new Og,h.X(e),d=d.getAsJspb(),G(h,2,d),F(h,4,g?16:8),"UNDEFINED_CSN"==e?Tq("visualElementHidden",h,f):eo(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?Tq("visualElementHidden",d,f):b?Dj("visualElementHidden",d,b,f):wk("visualElementHidden",
d,f)));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=k||"");lq({clientScreenNonce:k});Uq.getInstance().clear();d=so(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(L("web_mark_root_visible")||L("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:wo(e),W:e},L("il_via_jspb")?(b=new Og,b.X(e),f=d.getAsJspb(),G(b,2,f),F(b,4,1),"UNDEFINED_CSN"==e?Tq("visualElementShown",b,k):co(b,k,void 0)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==e?Tq("visualElementShown",b,k):wk("visualElementShown",
b,k)));a.i.delete(c.layer||0);a.j=void 0;e=q(a.u);for(k=e.next();!k.done;k=e.next())b=q(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Xq(a,k,d,c.layer);for(c=0;c<a.l.length;c++){e=a.l[c];try{e()}catch(m){Sn(m)}}for(c=a.l.length=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Sn(m)}}}
;function $q(){var a,b;return w(function(c){if(1==c.h)return a=rq.h,a?v(c,tq(a),2):(Tn(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.i)return b.errorMetadata?(Sn(Error("Datasync IDs fetch responded with "+b.errorMetadata.code+": "+b.error)),c.return(void 0)):c.return(b.zo);Tn(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var ar=y.caches,br;function cr(a){var b=a.indexOf(":");return-1===b?{Cb:a}:{Cb:a.substring(0,b),datasyncId:a.substring(b+1)}}
...
function fr(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.h)return v(h,dr(),2);if(3!=h.h){if(!h.i)return h.return(!1);a=Ak("cache contains other");return v(h,ar.keys(),3)}b=h.i;c=q(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=cr(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
;function gr(){try{return!!self.localStorage}catch(a){return!1}}
;function hr(a){a=a.match(/(.*)::.*::.*/);if(null!==a)return a[1]}
function ir(a){if(gr()){var b=Object.keys(window.localStorage);b=q(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=hr(c);void 0===d||a.includes(d)||self.localStorage.removeItem(c)}}}
function jr(){if(!gr())return!1;var a=Ak(),b=Object.keys(window.localStorage);b=q(b);for(var c=b.next();!c.done;c=b.next())if(c=hr(c.value),void 0!==c&&c!==a)return!0;return!1}
;function kr(){$q().then(function(a){a&&(Kl(a),er(a),ir(a))})}
function lr(){var a=new Wm;ai.N(function(){var b,c,d,e;return w(function(f){switch(f.h){case 1:if(L("ytidb_clear_optimizations_killswitch")){f.s(2);break}b=Ak("clear");if(b.startsWith("V")){var g=[b];Kl(g);er(g);ir(g);return f.return()}c=jr();return v(f,fr(),3);case 3:return d=f.i,v(f,Ll(),4);case 4:if(e=f.i,!c&&!d&&!e)return f.return();case 2:a.H()?kr():a.i.add("publicytnetworkstatus-online",kr,!0,void 0,void 0),f.h=0}})})}
;function mr(a){a&&(a.dataset?a.dataset[nr("loaded")]="true":a.setAttribute("data-loaded","true"))}
function or(a,b){return a?a.dataset?a.dataset[nr(b)]:a.getAttribute("data-"+b):null}
var pr={};function nr(a){return pr[a]||(pr[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var qr=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,rr=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function sr(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(qr,""),c=c.replace(rr,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else tr(a,b,c)}
function tr(a,b,c){c=void 0===c?null:c;var d=ur(a),e=document.getElementById(d),f=e&&or(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Pi(d,b),b=""+Pa(b),vr[b]=f),g||(e=wr(a,d,function(){or(e,"loaded")||(mr(e),Si(d),Rh(Va(Ti,d),0))},c)))}
function wr(a,b,c,d){d=void 0===d?null:d;var e=yd("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function xr(a){a=ur(a);var b=document.getElementById(a);b&&(Ti(a),b.parentNode.removeChild(b))}
function yr(a,b){a&&b&&(a=""+Pa(b),(a=vr[a])&&Ri(a))}
function ur(a){var b=document.createElement("a");Rb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Wb(a)}
var vr={};var zr=[],Ar=!1;function Br(){if(!L("disable_biscotti_fetch_for_ad_blocker_detection")&&!L("disable_biscotti_fetch_entirely_for_all_web_clients")&&Io()&&"1"!=rb()){var a=function(){Ar=!0;"google_ad_status"in window?th("DCLKSTAT",1):th("DCLKSTAT",2)};
try{sr("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}zr.push(ai.N(function(){if(!(Ar||"google_ad_status"in window)){try{yr("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Ar=!0;th("DCLKSTAT",3)}},5E3))}}
function Cr(){var a=Number(B("DCLKSTAT",0));return isNaN(a)?0:a}
;function Dr(){this.state=1;this.h=null}
l=Dr.prototype;
...
Er(this,f,g,a.program,b,c)}else Tn(Error("Cannot initialize botguard without program"))};
function Er(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,sr(c,function(){window[g]?Fr(a,d,g,e):(a.state=3,xr(c),Tn(new M("Unable to load Botguard","from "+c)))},f)):b?(f=yd("SCRIPT"),f.textContent=b,f.nonce=Ub(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Fr(a,d,g,e):(a.state=4,Tn(new M("Unable to load Botguard from JS")))):Tn(new M("Unable to load VM; no url or JS provided"))}
l.isInitialized=function(){return!!this.h};
l.getState=function(){return this.state};
function Fr(a,b,c,d){a.state=5;try{var e=new nd({program:b,globalName:c});e.uc.then(function(){a.state=6;d&&d(b)});
Gr(a,e)}catch(f){a.state=7,f instanceof Error&&Tn(f)}}
...
l.dispose=function(){Gr(this,null);this.state=8};
function Gr(a,b){$d(a.h);a.h=b}
;var Hr=new Dr;function Ir(){return Hr.isInitialized()}
function Jr(a){a=void 0===a?{}:a;return Hr.invoke(a)}
;function Kr(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?$h():d;this.l=c;this.j=d;this.i=new md;this.h=a;a={};c=q(this.h.entries());for(d=c.next();!d.done;a={ta:a.ta,Ca:a.Ca},d=c.next()){var e=q(d.value);d=e.next().value;e=e.next().value;a.Ca=d;a.ta=e;d=function(f){return function(){f.ta.fb();b.h[f.Ca].Sa=!0;b.h.every(function(g){return!0===g.Sa})&&b.i.resolve()}}(a);
e=Wh(d,Lr(this,a.ta));this.h[a.Ca]=Object.assign(Object.assign({},a.ta),{fb:d,Na:e})}}
function Mr(a){var b=Array.from(a.h.keys()).sort(function(d,e){return Lr(a,a.h[e])-Lr(a,a.h[d])});
b=q(b);for(var c=b.next();!c.done;c=b.next())c=a.h[c.value],void 0===c.Na||c.Sa||(a.j.U(c.Na),Wh(c.fb,10))}
Kr.prototype.cancel=function(){for(var a=q(this.h),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.Na||b.Sa||this.j.U(b.Na),b.Sa=!0;this.i.resolve()};
function Lr(a,b){var c;return null!==(c=b.priority)&&void 0!==c?c:a.l}
;function Nr(a){this.state=a;this.plugins=[];this.m=void 0}
Nr.prototype.install=function(){this.plugins.push.apply(this.plugins,ha(Ea.apply(0,arguments)))};
Nr.prototype.transition=function(a,b){var c=this,d=this.C.find(function(f){return f.from===c.state&&f.B===a});
if(d){this.j&&(Mr(this.j),this.j=void 0);this.state=a;d=d.action.bind(this);var e=this.plugins.filter(function(f){return f[a]}).map(function(f){return f[a]});
d(Or(this,e,this.m),b)}else throw Error("no transition specified from "+this.state+" to "+a);};
function Or(a,b,c){return function(){var d=Ea.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!==(m=null!==c&&void 0!==c?c:k.priority)&&void 0!==m?m:0)}),f=b.filter(function(k){var m;
...
r(Pr,Nr);Pr.prototype.u=function(a,b){if(!this.h.get("document_disposed_preventable")&&(a(b),(null===b||void 0===b?0:b.defaultPrevented)||(null===b||void 0===b?0:b.returnValue))){b.returnValue||(b.returnValue=!0);b.defaultPrevented||b.preventDefault();this.h=new Map;this.transition("document_active");return}this.h.set("document_disposed_preventable",!0);this.h.get("document_disposed")?this.transition("flush_logs"):this.transition("document_disposed")};
Pr.prototype.l=function(a,b){this.h.get("document_disposed")?this.transition("document_active"):(a(b),this.h.set("document_disposed",!0),this.transition("flush_logs"))};
Pr.prototype.o=function(a,b){a(b);this.transition("document_active")};
Pr.prototype.i=function(){this.h=new Map};function Qr(a){Nr.call(this,void 0===a?"document_visibility_unknown":a);var b=this;this.C=[{from:"document_visibility_unknown",B:"document_visible",action:this.i},{from:"document_visibility_unknown",B:"document_hidden",action:this.h},{from:"document_visibility_unknown",B:"document_foregrounded",action:this.o},{from:"document_visibility_unknown",B:"document_backgrounded",action:this.l},{from:"document_visible",B:"document_hidden",action:this.h},{from:"document_visible",B:"document_foregrounded",action:this.o},
...
r(Qr,Nr);Qr.prototype.i=function(a,b){a(b);L("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
Qr.prototype.h=function(a,b){a(b);L("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
Qr.prototype.l=function(a,b){a(b)};
Qr.prototype.o=function(a,b){a(b)};function Rr(){this.h=new Pr;this.i=new Qr}
Rr.prototype.install=function(){var a=Ea.apply(0,arguments);this.h.install.apply(this.h,ha(a));this.i.install.apply(this.i,ha(a))};function Sr(){Rr.call(this);var a={};this.install((a.document_disposed={la:this.j},a));a={};this.install((a.flush_logs={la:this.l},a))}
var Tr;r(Sr,Rr);Sr.prototype.l=function(){wk("finalPayload",{csn:uo()})};
Sr.prototype.j=function(){Wn(Xn)};function Ur(){}
Ur.getInstance=function(){var a=A("ytglobal.storage_");a||(a=new Ur,z("ytglobal.storage_",a,void 0));return a};
Ur.prototype.estimate=function(){var a,b,c;return w(function(d){c=navigator;return(null===(a=c.storage)||void 0===a?0:a.estimate)?d.return(c.storage.estimate()):(null===(b=c.webkitTemporaryStorage)||void 0===b?0:b.queryUsageAndQuota)?d.return(Vr()):d.return()})};
function Vr(){var a=navigator;return new Promise(function(b,c){var d;null!==(d=a.webkitTemporaryStorage)&&void 0!==d&&d.queryUsageAndQuota?a.webkitTemporaryStorage.queryUsageAndQuota(function(e,f){b({usage:e,quota:f})},function(e){c(e)}):c(Error("webkitTemporaryStorage is not supported."))})}
z("ytglobal.storageClass_",Ur,void 0);function uk(a,b){var c=this;this.handleError=a;this.h=b;this.i=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.i=!0});
this.j=Math.random()<=wh("ytidb_transaction_ended_event_rate_limit",.02)}
uk.prototype.logEvent=function(a,b){switch(a){case "IDB_DATA_CORRUPTED":L("idb_data_corrupted_killswitch")||this.h("idbDataCorrupted",b);break;case "IDB_UNEXPECTEDLY_CLOSED":this.h("idbUnexpectedlyClosed",b);break;case "IS_SUPPORTED_COMPLETED":L("idb_is_supported_completed_killswitch")||this.h("idbIsSupportedCompleted",b);break;case "QUOTA_EXCEEDED":Wr(this,b);break;case "TRANSACTION_ENDED":this.j&&this.h("idbTransactionEnded",b);break;case "TRANSACTION_UNEXPECTEDLY_ABORTED":a=Object.assign(Object.assign({},
b),{hasWindowUnloaded:this.i}),this.h("idbTransactionAborted",a)}};
function Wr(a,b){Ur.getInstance().estimate().then(function(c){c=Object.assign(Object.assign({},b),{isSw:void 0===self.document,isIframe:self!==self.top,deviceStorageUsageMbytes:Xr(null===c||void 0===c?void 0:c.usage),deviceStorageQuotaMbytes:Xr(null===c||void 0===c?void 0:c.quota)});a.h("idbQuotaExceeded",c)})}
function Xr(a){return"undefined"===typeof a?"-1":String(Math.ceil(a/1048576))}
;var Yr=window;
function Zr(){var a=Yr.uaChPolyfill.state;if(0===a.type)wk("clientHintsPolyfillEvent",{clientHintsSupported:!1});else{var b=navigator.userAgent,c=void 0!==a.syntheticUa&&a.syntheticUa===b,d={clientHintsSupported:!0,uaAccessedBeforePolyfill:a.didAccessUaBeforePolyfillAvailable,syntheticUaMatches:c};a.didAccessUaBeforePolyfillAvailable&&(d.uaAccessBeforePolyfillCount=a.uaAccessBeforePolyfillCount,a.firstAccessUaError&&(d.firstUaAccessStack=String(a.firstAccessUaError.stack).replace(/\n/g,""),Sn(a.firstAccessUaError)),
...
b))}}
var $r=!1;function as(){var a;1===(null===(a=Yr.uaChPolyfill)||void 0===a?void 0:a.state.type)?$r||(Yr.uaChPolyfill.onReady=as,$r=!0):Yr.uaChPolyfill&&Zr()}
;function bs(a,b,c){I.call(this);var d=this;c=c||B("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.L="*";this.l=c;this.sessionId=null;this.channel="widget";this.M=!!a;this.A=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.M&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(bs,I);bs.prototype.sendMessage=function(a,b){if(b=b||this.j){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.L)}catch(d){Hh(d)}}};
bs.prototype.I=function(){window.removeEventListener("message",this.A);I.prototype.I.call(this)};function cs(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new bs(!!B("WIDGET_ID_ENFORCE")),b=this.fc.bind(this);a.m=b;a.u=null;this.h.channel="widget";if(a=B("WIDGET_ID"))this.h.sessionId=a}
l=cs.prototype;l.fc=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,ds(this,a)),this.j[a]=!0)):this.lb(a,b,c)};
l.lb=function(){};
function ds(a,b){return function(c){return a.sendMessage(b,c)}}
...
function es(a,b){a.sendMessage("infoDelivery",b)}
...
l.dispose=function(){this.h=null};function fs(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function gs(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function hs(a,b,c,d){if(Oa(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function is(a){cs.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.qc.bind(this));this.addEventListener("onVolumeChange",this.sc.bind(this));this.addEventListener("onApiChange",this.kc.bind(this));this.addEventListener("onPlaybackQualityChange",this.nc.bind(this));this.addEventListener("onPlaybackRateChange",this.oc.bind(this));this.addEventListener("onStateChange",this.pc.bind(this));this.addEventListener("onWebglSettingsChanged",
this.tc.bind(this))}
r(is,cs);l=is.prototype;
l.lb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&fs(a)){var d=b;if(Oa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=gs(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=gs(e);break;case "loadPlaylist":case "cuePlaylist":e=hs(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);fs(a)&&es(this,this.Ya())}};
...
(a.videoUrl=this.api.getVideoUrl());this.api.getVideoContentRect&&(a.videoContentRect=this.api.getVideoContentRect());this.api.getProgressState&&(a.progressState=this.api.getProgressState());this.api.getPlaylist&&(a.playlist=this.api.getPlaylist());this.api.getPlaylistIndex&&(a.playlistIndex=this.api.getPlaylistIndex());this.api.getStoryboardFormat&&(a.storyboardFormat=this.api.getStoryboardFormat());es(this,a)};
l.nc=function(a){es(this,{playbackQuality:a})};
l.oc=function(a){es(this,{playbackRate:a})};
...
l.sc=function(){es(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
l.qc=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());es(this,a)};
l.tc=function(){var a={sphericalProperties:this.api.getSphericalProperties()};es(this,a)};
l.dispose=function(){cs.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function js(a){I.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Eb,this)}
r(js,I);l=js.prototype;l.start=function(){this.started||this.h()||(this.started=!0,this.connection.ma("RECEIVING"))};
l.ma=function(a,b){this.started&&!this.h()&&this.connection.ma(a,b)};
l.Eb=function(a,b,c){if(this.started&&!this.h()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=ks(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=ls(a,c))&&this.ma(a,c))}}};
...
l.I=function(){var a=this.connection;a.h()||Zf(a.i,"command",this.Eb,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);I.prototype.I.call(this)};function ms(a,b){js.call(this,b);this.api=a;this.start()}
r(ms,js);ms.prototype.addEventListener=function(a,b){this.api.addEventListener(a,b)};
ms.prototype.removeEventListener=function(a,b){this.api.removeEventListener(a,b)};
function ks(a,b){switch(a){case "loadVideoById":return a=gs(b),[a];case "cueVideoById":return a=gs(b),[a];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return a=hs(b),[a];case "cuePlaylist":return a=hs(b),[a];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey,b.ctrlKey,b.altKey,b.metaKey,b.key,b.code]}return[]}
function ls(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
ms.prototype.Xa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return js.prototype.Xa.call(this,a,b)};
ms.prototype.I=function(){js.prototype.I.call(this);delete this.api};function ns(a){a=void 0===a?!1:a;I.call(this);this.i=new J(a);be(this,Va($d,this.i))}
Xa(ns,I);ns.prototype.subscribe=function(a,b,c){return this.h()?0:this.i.subscribe(a,b,c)};
ns.prototype.l=function(a,b){this.h()||this.i.ka.apply(this.i,arguments)};function os(a,b,c){ns.call(this);this.j=a;this.destination=b;this.id=c}
r(os,ns);os.prototype.ma=function(a,b){this.h()||this.j.ma(this.destination,this.id,a,b)};
os.prototype.I=function(){this.destination=this.j=null;ns.prototype.I.call(this)};function ps(a,b,c){I.call(this);this.destination=a;this.origin=c;this.i=Oh(window,"message",this.j.bind(this));this.connection=new os(this,a,b);be(this,Va($d,this.connection))}
r(ps,I);ps.prototype.ma=function(a,b,c,d){this.h()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Af(a),this.origin))};
ps.prototype.j=function(a){var b;if(b=!this.h())if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h()||c.l("command",b.command,b.data,a.origin))}};
ps.prototype.I=function(){Ph(this.i);this.destination=null;I.prototype.I.call(this)};function qs(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||tb(b);this.assets=a.assets||{};this.attrs=a.attrs||tb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
qs.prototype.clone=function(){var a=new qs,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ma(c)?a[b]=tb(c):a[b]=c}return a};var rs=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function ss(a){a=a||"";if(window.spf){var b=a.match(rs);spf.style.load(a,b?b[1]:"",void 0)}else ts(a)}
function ts(a){var b=us(a),c=document.getElementById(b),d=c&&or(c,"loaded");d||c&&!d||(c=vs(a,b,function(){or(c,"loaded")||(mr(c),Si(b),Rh(Va(Ti,b),0))}))}
function vs(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=yf(a);Sb(d,a);(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function us(a){var b=yd("A");Bb("This URL is never added to the DOM");Rb(b,new Jb(a,Kb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Wb(a)}
;function ws(){I.call(this);this.i=[]}
r(ws,I);ws.prototype.I=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.la,void 0)}I.prototype.I.call(this)};function xs(){ws.apply(this,arguments)}
r(xs,ws);function ys(a,b,c,d){I.call(this);var e=this;this.M=b;this.webPlayerContextConfig=d;this.Ua=!1;this.api={};this.Ea=this.u=null;this.S=new J;this.i={};this.ga=this.Fa=this.elementId=this.Va=this.config=null;this.Y=!1;this.l=this.A=null;this.Ga={};this.Lb=["onReady"];this.lastError=null;this.mb=NaN;this.L={};this.Mb=new xs(this);this.oa=0;this.j=this.m=a;be(this,Va($d,this.S));zs(this);As(this);be(this,Va($d,this.Mb));c?this.oa=Rh(function(){e.loadNewVideoConfig(c)},0):d&&(Bs(this),Cs(this))}
r(ys,I);l=ys.prototype;l.getId=function(){return this.M};
l.loadNewVideoConfig=function(a){if(!this.h()){this.oa&&(Sh(this.oa),this.oa=0);var b=a||{};b instanceof qs||(b=new qs(b));this.config=b;this.setConfig(a);Cs(this);this.isReady()&&Ds(this)}};
function Bs(a){var b,c;a.webPlayerContextConfig?c=a.webPlayerContextConfig.rootElementId:c=a.config.attrs.id;a.elementId=c||a.elementId;"video-player"===a.elementId&&(a.elementId=a.M,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.M:a.config.attrs.id=a.M);(null===(b=a.j)||void 0===b?void 0:b.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
l.setConfig=function(a){var b;this.Va=a;this.config=Es(a);Bs(this);this.Fa||(this.Fa=Fs(this,(null===(b=this.config.args)||void 0===b?void 0:b.jsapicallback)||"onYouTubePlayerReady"));this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null===(c=this.config)||void 0===c?0:c.attrs)a=this.config.attrs,(c=a.width)&&this.j&&(this.j.style.width=Kd(Number(c)||c)),(a=a.height)&&this.j&&(this.j.style.height=Kd(Number(a)||a))};
function Ds(a){var b;a.config&&!0!==a.config.loaded&&(a.config.loaded=!0,!a.config.args||"0"!==a.config.args.autoplay&&0!==a.config.args.autoplay&&!1!==a.config.args.autoplay?a.api.loadVideoByPlayerVars(null!==(b=a.config.args)&&void 0!==b?b:null):a.api.cueVideoByPlayerVars(a.config.args))}
function Gs(a){var b=!0,c=Hs(a);c&&a.config&&(a=Is(a),b=or(c,"version")===a);return b&&!!A("yt.player.Application.create")}
function Cs(a){if(!a.h()&&!a.Y){var b=Gs(a);if(b&&"html5"===(Hs(a)?"html5":null))a.ga="html5",a.isReady()||Js(a);else if(Ks(a),a.ga="html5",b&&a.l&&a.m)a.m.appendChild(a.l),Js(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=Ls(a,"player_bootstrap_method")?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.config?Es(a.config):void 0;d&&d(a.m,e,a.webPlayerContextConfig);Js(a)};
a.Y=!0;b?a.A():(sr(Is(a),a.A),(b=Ms(a))&&ss(b),Ns(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Hs(a){var b=xd(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Js(a){var b;if(!a.h()){var c=Hs(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.Y=!1,!Ls(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||Os(a)):a.mb=Rh(function(){Js(a)},50)}}
function Os(a){zs(a);a.Ua=!0;var b=Hs(a);if(b){a.u=Ps(a,b,"addEventListener");a.Ea=Ps(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Ps(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.u&&a.u(g,a.i[g]);Ds(a);a.Fa&&a.Fa(a.api);a.S.ka("onReady",a.api)}
function Ps(a,b,c){var d=b[c];return function(){var e=Ea.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Tn(f))}}}
function zs(a){a.Ua=!1;if(a.Ea)for(var b in a.i)a.i.hasOwnProperty(b)&&a.Ea(b,a.i[b]);for(var c in a.L)a.L.hasOwnProperty(c)&&Sh(Number(c));a.L={};a.u=null;a.Ea=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function As(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Si("WATCH_LATER_VIDEO_ADDED",b)});
...
l.addEventListener=function(a,b){var c=this,d=Fs(this,b);d&&(0<=db(this.Lb,a)||this.i[a]||(b=Qs(this,a),this.u&&this.u(a,b)),this.S.subscribe(a,d),"onReady"===a&&this.isReady()&&Rh(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.h()||(b=Fs(this,b))&&Zf(this.S,a,b)};
function Fs(a,b){var c=b;if("string"===typeof b){if(a.Ga[b])return a.Ga[b];c=function(){var d=Ea.apply(0,arguments),e=A(b);if(e)try{e.apply(y,d)}catch(f){Sn(f)}};
a.Ga[b]=c}return c?c:null}
function Qs(a,b){var c="ytPlayer"+b+a.M;a.i[b]=c;y[c]=function(d){var e=Rh(function(){if(!a.h()){a.S.ka(b,null!==d&&void 0!==d?d:void 0);var f=a.L,g=String(e);g in f&&delete f[g]}},0);
qb(a.L,String(e))};
return c}
l.getPlayerType=function(){return this.ga||(Hs(this)?"html5":null)};
l.getLastError=function(){return this.lastError};
function Ks(a){a.cancel();zs(a);a.ga=null;a.config&&(a.config.loaded=!1);var b=Hs(a);b&&(Gs(a)||!Ns(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.m)for(a=a.m;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.A&&yr(Is(this),this.A);Sh(this.mb);this.Y=!1};
l.I=function(){Ks(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){Sn(b)}this.Ga=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.Va=this.config=this.api=null;delete this.m;delete this.j;I.prototype.I.call(this)};
function Ns(a){var b,c;a=null===(c=null===(b=a.config)||void 0===b?void 0:b.args)||void 0===c?void 0:c.fflags;return!!a&&-1!==a.indexOf("player_destroy_old_version=true")}
function Is(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.jsUrl:(a=a.config.assets)?a.js:""}
function Ms(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.cssUrl:(a=a.config.assets)?a.css:""}
function Ls(a,b){var c;if(a.webPlayerContextConfig)var d=a.webPlayerContextConfig.serializedExperimentFlags;else if(null===(c=a.config)||void 0===c?0:c.args)d=a.config.args.fflags;return"true"===li(d||"","&")[b]}
function Es(a){for(var b={},c=q(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?tb(e):e}return b}
;var Rs={},Ss="player_uid_"+(1E9*Math.random()>>>0);function Ts(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?xd(d):d;var e=Ss+"_"+Pa(d),f=Rs[e];if(f&&c)return Us(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new ys(d,e,a,b);Rs[e]=f;Si("player-added",f.api);be(f,function(){delete Rs[f.getId()]});
return f.api}
function Us(a,b){return b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags?a.args.fflags.includes("web_player_remove_playerproxy=true"):!1}
;var Vs=null,Ws=null,Xs=null;function Ys(){var a=Vs.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
;function Zs(a,b,c){a="ST-"+Wb(a).toString(36);b=b?bc(b):"";c=c||5;Io()&&Ij(a,b,c)}
;function $s(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=B("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=B("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Zb(window.location.href);g&&f.push(g);g=Zb(d);if(0<=db(f,g)||!g&&0==d.lastIndexOf("/",0))if(L("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d&&(d=$b(d),f=d.indexOf("#"),d=0>f?d:d.substr(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:uo()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
Zs(d,b,h)}else Zs(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var n=void 0===n?window:n;c=n.location;a=cc(a,k)+m;var t=void 0===t?Jd:t;a:{t=void 0===t?Jd:t;for(k=0;k<t.length;++k)if(m=t[k],m instanceof Hd&&m.isValid(a)){t=new rd(a,pd);break a}t=void 0}c.href=td(t||sd)}return!0}
...
z("writeEmbed",function(){var a=B("PLAYER_CONFIG",void 0);if(!a){var b=B("PLAYER_VARS",void 0);b&&(a={args:b})}Qo(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=B("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);L("embeds_js_api_set_1p_cookie")&&(c=qi(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));hq();
if((c=B("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=qi(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Vs=Ts(a,c,!1)}else Vs=Ts(a);Vs.addEventListener("onVideoDataChange",Ys);a=B("POST_MESSAGE_ID","player");B("ENABLE_JS_API")?Xs=new is(Vs):B("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Ws=new ps(window.parent,
a,b),Xs=new ms(Vs,Ws.connection));Br();L("ytidb_create_logger_embed_killswitch")||tk();L("flush_gel_on_teardown")&&(a={},Tr||(Tr=new Sr),Tr.install((a.flush_logs={la:function(){kj()}},a)));
L("networkless_logging_web_embedded")&&(L("embeds_web_enable_new_nwl")?cn():ln());L("embeds_enable_ua_ch_polyfill")&&as();L("ytidb_clear_embedded_player")&&ai.N(function(){if(!Lq){var e={pb:{feedbackEndpoint:gp(Fq),modifyChannelNotificationPreferenceEndpoint:gp(Gq),playlistEditEndpoint:gp(Hq),subscribeEndpoint:gp(Dq),unsubscribeEndpoint:gp(Eq),webPlayerShareEntityServiceEndpoint:gp(Iq)}},f=L("web_enable_client_location_service")?ap.getInstance():void 0,g={};f&&(g.client_location=f);if(void 0===h){Ro.h||
(Ro.h=new Ro);var h=Ro.h}if(void 0===k){Kq.h||(Kq.h=new Kq);var k=Kq.h}sq(e,k,h,g);Lq=rq.h}lr()})},void 0);
var at=Fh(function(){oq();var a=Mj.getInstance(),b=Pj(119),c=1<window.devicePixelRatio;if(document.body&&hf(document.body,"exp-invert-logo"))if(c&&!hf(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!hf(d,"inverted-hdpi")){var e=ff(d);gf(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&hf(document.body,"inverted-hdpi")&&jf();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Qj(b)||0;d=c?d|67108864:d&-67108865;0==d?delete Lj[b]:(c=d.toString(16),
Lj[b]=c.toString());c=!0;L("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in Lj)d.push(f+"="+encodeURIComponent(String(Lj[f])));Ij(b,d.join("&"),63072E3,a.i,c)}Vq.h||(Vq.h=new Vq);a=Vq.h;f=16623;var g=void 0===g?{}:g;Object.values(Ao).includes(f)||(Tn(new M("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.o=[];a.C=[];g.sb?Yq(a,f,g):Zq(a,f,g)}),bt=Fh(function(){Vs&&Vs.sendAbandonmentPing&&Vs.sendAbandonmentPing();
B("PL_ATT")&&Hr.dispose();for(var a=0,b=zr.length;a<b;a++)ai.U(zr[a]);zr.length=0;xr("//static.doubleclick.net/instream/ad_status.js");Ar=!1;th("DCLKSTAT",0);ae(Xs,Ws);Vs&&(Vs.removeEventListener("onVideoDataChange",Ys),Vs.destroy())});
window.addEventListener?(window.addEventListener("load",at),L("embeds_web_enable_replace_unload_w_pagehide")?window.addEventListener("pagehide",bt):window.addEventListener("unload",bt)):window.attachEvent&&(window.attachEvent("onload",at),window.attachEvent("onunload",bt));Wa("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||Ir);Wa("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||Jr);
Wa("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||Cr);Wa("yt.player.exports.navigate",A("yt.player.exports.navigate")||$s);Wa("yt.util.activity.init",A("yt.util.activity.init")||ci);Wa("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||fi);Wa("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||di);}).call(this);
